...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:26px;">教咱们家诗雨怎么玩：</span><br /><span style="font-size:15px;"><br />1.果果可以随意拖动圆球；<br />2.果果可以点击页面背景；<br />3. 把浏览器页面缩小然后晃动；<br />4. 双击页面背景换颜色重开。</span>';
